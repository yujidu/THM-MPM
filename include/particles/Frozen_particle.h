#ifndef MPM_FROZEN_PARTICLE_H_
#define MPM_FROZEN_PARTICLE_H_
...
class FrozenParticle : public mpm::Particle<Tdim> {
...
public:
  ...
  // Destructor
  ~FrozenParticle() override{};

  // Delete copy constructor
  FrozenParticle(const FrozenParticle<Tdim>&) = delete;

  // Delete assignment operator
  FrozenParticle& operator = (const FrozenParticle<Tdim>&) = delete;
