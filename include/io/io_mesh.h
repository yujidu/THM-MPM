...
class IOMesh {
 public:
  ...
  //! \param[in] particles_temperatures file name with particle temperature
  //! \retval Vector of particles temperatures
  virtual std::vector<double> read_particles_temperatures(
      const std::string& particles_temperatures) = 0;
  ...
  virtual std::vector<std::tuple<mpm::Index, double>> read_pressure_constraints(
      const std::string& pressure_constraints_file) = 0;
  ...
  virtual std::vector<double> read_particles_volumes(
  ...
  //! \param[in] temperature_constraints_files file name with temperature constraints
