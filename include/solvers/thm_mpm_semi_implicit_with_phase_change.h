#ifndef MPM_THM_MPM_SEMI_IMPLICIT_PHASE_CHANGE_H_
#define MPM_THM_MPM_SEMI_IMPLICIT_PHASE_CHANGE_H_
...
//! THMMPMSemiImplicitPhaseChange class
//! \brief A class that implements the semi-implicit one phase mpm
//! \details A two-phase semi-implicit MPM
//! \tparam Tdim Dimension
template <unsigned Tdim>
class THMMPMSemiImplicitPhaseChange : public MPMBase<Tdim> {
 public:
  //! Default constructor
  THMMPMSemiImplicitPhaseChange(const std::shared_ptr<IO>& io);
...
#include "thm_mpm_semi_implicit_with_phase_change.tcc"
