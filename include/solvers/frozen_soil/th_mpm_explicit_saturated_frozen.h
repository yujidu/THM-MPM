#ifndef TH_MPM_EXPLICIT_SATURATED_FROZEN_SOIL_H_
#define TH_MPM_EXPLICIT_SATURATED_FROZEN_SOIL_H_
...
//! THMPMExplicitSatFrozen class
//! \brief A class that implements the semi-implicit one phase mpm
//! \details An explicit hydro-thermal MPM for frozen soil
//! \tparam Tdim Dimension
template <unsigned Tdim>
class THMPMExplicitSatFrozen : public MPMBase<Tdim> {
 public:
  //! Default constructor
  THMPMExplicitSatFrozen(const std::shared_ptr<IO>& io);
...
#include "th_mpm_explicit_saturated_frozen.tcc"
