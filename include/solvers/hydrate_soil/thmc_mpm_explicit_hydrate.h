...
//! THMCMPMExplicitHydrate class
//! \brief A class that implements the fully explicit TWO phase mpm
//! \details A TWO-phase explicit MPM
//! \tparam Tdim Dimension
template <unsigned Tdim>
class THMCMPMExplicitHydrate : public MPMBase<Tdim> {
 public:
  //! Default constructor
  THMCMPMExplicitHydrate(const std::shared_ptr<IO>& io);
...
#include "thmc_mpm_explicit_hydrate.tcc"
