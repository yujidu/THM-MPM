#ifndef THC_MPM_EXPLICIT_HYDRATE_H_
#define THC_MPM_EXPLICIT_HYDRATE_H_
...
class THCMPMExplicitHydrate : public MPMBase<Tdim> {
 public:
  //! Default constructor
  THCMPMExplicitHydrate(const std::shared_ptr<IO>& io);
...
#include "thc_mpm_explicit_hydrate.tcc"

#endif  // THC_MPM_EXPLICIT_HYDRATE_H_
