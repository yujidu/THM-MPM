...
//! Add a neighbour cell and return the status of addition of a node
template <unsigned Tdim>
bool mpm::Cell<Tdim>::add_nonlocal_neighbour(mpm::Index neighbour_id) {
  bool insertion_status = false;
  try {
    insertion_status = (nonlocal_neighbours_.insert(neighbour_id)).second;
  } catch (std::exception& exception) {
    console_->error("{} {}: {}\n", __FILE__, __LINE__, exception.what());
  }
  return insertion_status;
...
//! Add a neighbour cell and return the status of addition of a node
template <unsigned Tdim>
bool mpm::Cell<Tdim>::add_nonlocal_neighbour_particle(mpm::Index neighbour_id) {
  bool insertion_status = false;
  try {
    insertion_status = (nonlocal_neighbour_particles_.insert(neighbour_id)).second;
  } catch (std::exception& exception) {
    console_->error("{} {}: {}\n", __FILE__, __LINE__, exception.what());
  }
  return insertion_status;
