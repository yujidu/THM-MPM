...
class Traction {
 public:
  ...
  //! \param[facet] facet of traction load [0:5] stands for [+x, -x, +y, -y, +z,
  //! -z]
  //! \param[dir] dir Direction of traction load \param[traction] traction
  //! traction
  ...
  // Facet
  unsigned facet() const { return facet_; }
