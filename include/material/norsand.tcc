...
Eigen::Matrix<double, 6, 1> mpm::NorSand<Tdim>::compute_stress(
  ...
  plastic_work_ = (-updated_stress(0)) * dpstrain(0) + 
                    (-updated_stress(1)) * dpstrain(1) + 
                    (-updated_stress(2)) * dpstrain(2) + 
                    (-updated_stress(3)) * dpstrain(3) * 2 +                     
                    (-updated_stress(4)) * dpstrain(4) * 2 +  
                    (-updated_stress(5)) * dpstrain(5) * 2;         
