#ifndef MPM_MATERIAL_MOHR_COULOMB_FROZENSOIL_H_
#define MPM_MATERIAL_MOHR_COULOMB_FROZENSOIL_H_
...
class MohrCoulomb_FrozenSoil : public Material<Tdim> {
 public:
  ...
  MohrCoulomb_FrozenSoil(unsigned id, const Json& material_properties);

  //! Destructor
  ~MohrCoulomb_FrozenSoil() override{};

  //! Delete copy constructor
  MohrCoulomb_FrozenSoil(const MohrCoulomb_FrozenSoil&) = delete;

  //! Delete assignement operator
  MohrCoulomb_FrozenSoil& operator=(const MohrCoulomb_FrozenSoil&) = delete;
 ...
 private:
  ...
  //! Maximum additional cohesion
  double dcohesion_max_{std::numeric_limits<double>::max()};
  //! Maximum additional phi
  double dphi_max_{std::numeric_limits<double>::max()};
  //! SFCC parameters
  ...
  double eta_c_{std::numeric_limits<double>::max()}; 
  double sf_{std::numeric_limits<double>::max()};       
  // yield type
...
#include "MC_frozen_soil.tcc"

#endif  // MPM_MATERIAL_MOHR_COULOMB_FROZENSOIL_H_
